...
export const DEFAULT_SETTINGS: SettingsState = {
  ...
  tabsReloadBatchDelayEvery: 2,
  tabsReloadBatchDelayMs: 1000,
  tabsReloadBatchDelayMin: 20,
  showNewTabBtns: true,
  ...
  moveNewTabParentLimited: 'default',
...
export const SETTINGS_OPTIONS = {
  ...
  groupSortDefault: ['default', 'reverse', 'domain', 'title', 'url'],
