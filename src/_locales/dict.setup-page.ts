...
例：「*」、「ctrl+$」、「ctrl+alt+g」`,
  ...
  'settings.tabs_reload_batch_delay': {
    en: 'Extra delay between batches on bulk reload',
    de: 'Zusätzliche Verzögerung zwischen Stapeln beim Massen-Neuladen',
    fr: 'Délai supplémentaire entre les lots lors du rechargement en masse',
    hu: 'Extra késleltetés a kötegek között tömeges újratöltéskor',
    pl: 'Dodatkowe opóźnienie między partiami przy masowym przeładowaniu',
    ru: 'Доп. задержка между партиями при массовой перезагрузке',
    zh_CN: '批量重新加载时在每批之间额外延迟',
    zh_TW: '批次重新載入時在每批之間額外延遲',
    ja: '一括再読み込み時にバッチ間の追加遅延',
  },
  'settings.tabs_reload_batch_delay_every': {
    en: 'Wait after every N batches',
    de: 'Warten nach je N Stapeln',
    fr: 'Attendre après chaque N lots',
    hu: 'Várakozás minden N köteg után',
    pl: 'Czekaj po każdych N partiach',
    ru: 'Ждать после каждых N партий',
    zh_CN: '每 N 批后等待',
    zh_TW: '每 N 批後等待',
    ja: 'Nバッチごとに待機',
  },
  'settings.tabs_reload_batch_delay_ms': {
    en: 'Delay duration (ms)',
    de: 'Verzögerungsdauer (ms)',
    fr: 'Durée du délai (ms)',
    hu: 'Késleltetés időtartama (ms)',
    pl: 'Czas opóźnienia (ms)',
    ru: 'Длительность задержки (мс)',
    zh_CN: '延迟时长（毫秒）',
    zh_TW: '延遲時長（毫秒）',
    ja: '遅延時間（ミリ秒）',
  },
  'settings.tabs_reload_batch_delay_min': {
    en: 'Only when reloading more than N tabs',
    de: 'Nur beim Neuladen von mehr als N Tabs',
    fr: 'Seulement lors du rechargement de plus de N onglets',
    hu: 'Csak N-nél több lap újratöltésekor',
    pl: 'Tylko przy przeładowaniu więcej niż N kart',
    ru: 'Только при перезагрузке более N вкладок',
    zh_CN: '仅当重新加载超过 N 个标签页时',
    zh_TW: '僅當重新載入超過 N 個分頁時',
    ja: 'N個を超えるタブを再読み込みする場合のみ',
  },
