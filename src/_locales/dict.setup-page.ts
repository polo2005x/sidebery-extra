...
例：「*」、「ctrl+$」、「ctrl+alt+g」`,
  ...
  'settings.dedup_keep_newest': {
    en: 'On closing duplicate tabs, keep the newest',
    de: 'Beim Schließen doppelter Tabs den neuesten behalten',
    fr: 'Lors de la fermeture des onglets en double, garder le plus récent',
    hu: 'Ismétlődő lapok bezárásakor a legújabb megtartása',
    pl: 'Przy zamykaniu zduplikowanych kart zachowaj najnowszą',
    ru: 'При закрытии дубликатов оставлять новую вкладку',
    zh_CN: '关闭重复标签页时保留最新的',
    zh_TW: '關閉重複分頁時保留最新的',
    ja: '重複タブを閉じるときに最新のものを残す',
  },
