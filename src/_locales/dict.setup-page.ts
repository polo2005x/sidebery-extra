...
例：「*」、「ctrl+$」、「ctrl+alt+g」`,
  ...
  'settings.dedup_keep_newest': {
    en: 'Reverse tab order for Deduplicate',
    de: 'Tab-Reihenfolge für Deduplizieren umkehren',
    fr: 'Inverser l’ordre des onglets pour Dédupliquer',
    hu: 'Lapsorrend megfordítása a Deduplikációhoz',
    pl: 'Odwróć kolejność kart dla Deduplikacji',
    ru: 'Обратный порядок вкладок для Дедупликации',
    zh_CN: '反转去重的标签页顺序',
    zh_TW: '反轉去重的分頁順序',
    ja: '重複排除のタブ順序を反転',
  },
