...
Vous pouvez également définir des préfixes pour chaque type de commande pour une navigation plus rapide. Commencer votre requête (après le “=” et l’espace) avec un des préfixes configurés donnera aux commandes de ce type une plus grande priorité`,
  ...
  'settings.group_sort': {
    en: 'Show sort dropdown on the group page',
    de: 'Sortier-Dropdown auf der Gruppenseite anzeigen',
    fr: 'Afficher le menu de tri sur la page de groupe',
    hu: 'Rendezési legördülő megjelenítése a csoport oldalán',
    pl: 'Pokaż menu sortowania na stronie grupy',
    ru: 'Показывать меню сортировки на странице группы',
    zh_CN: '在群组页面显示排序下拉菜单',
    zh_TW: '在群組頁面顯示排序下拉選單',
    ja: 'グループページに並べ替えメニューを表示',
  },
  'settings.group_sort_default': {
    en: 'Default sort order on the group page',
    de: 'Standard-Sortierreihenfolge auf der Gruppenseite',
    fr: 'Ordre de tri par défaut sur la page de groupe',
    hu: 'Alapértelmezett rendezési sorrend a csoport oldalán',
    pl: 'Domyślna kolejność sortowania na stronie grupy',
    ru: 'Порядок сортировки по умолчанию на странице группы',
    zh_CN: '群组页面的默认排序方式',
    zh_TW: '群組頁面的預設排序方式',
    ja: 'グループページの既定の並べ替え順',
  },
  'settings.group_sort_mode_default': {
    en: 'Default (tree order)',
    de: 'Standard (Baumreihenfolge)',
    fr: 'Par défaut (ordre de l’arbre)',
    hu: 'Alapértelmezett (fa sorrend)',
    pl: 'Domyślna (kolejność drzewa)',
    ru: 'По умолчанию (порядок дерева)',
    zh_CN: '默认（树形顺序）',
    zh_TW: '預設（樹狀順序）',
    ja: '既定（ツリー順）',
  },
  'settings.group_sort_mode_reverse': {
    en: 'Reverse',
    de: 'Umgekehrt',
    fr: 'Inversé',
    hu: 'Fordított',
  ...
  'settings.group_sort_mode_domain': {
    en: 'By domain',
    de: 'Nach Domain',
    fr: 'Par domaine',
    hu: 'Domain szerint',
  ...
  'settings.group_sort_mode_title': {
    en: 'By title',
    de: 'Nach Titel',
    fr: 'Par titre',
    hu: 'Cím szerint',
  ...
  'settings.group_sort_mode_url': {
    en: 'By URL',
    de: 'Nach URL',
    fr: 'Par URL',
    hu: 'URL szerint',
    pl: 'Według adresu URL',
    ru: 'По URL',
    zh_CN: '按网址',
    zh_TW: '按網址',
    ja: 'URL順',
  },
  'settings.group_recent': {
    en: 'Show "Recently active tabs" box on the group page',
    de: '"Kürzlich aktive Tabs" auf der Gruppenseite anzeigen',
    fr: 'Afficher la boîte « Onglets récemment actifs » sur la page de groupe',
    hu: '„Nemrég használt lapok” doboz megjelenítése a csoport oldalán',
    pl: 'Pokaż pole „Ostatnio aktywne karty” na stronie grupy',
    ru: 'Показывать блок «Недавно активные вкладки» на странице группы',
    zh_CN: '在群组页面显示"最近活动的标签页"框',
    zh_TW: '在群組頁面顯示「最近活動的分頁」框',
    ja: 'グループページに「最近アクティブなタブ」を表示',
  },
  'settings.group_fav': {
    en: 'Show "Favourites" box on the group page',
    de: '"Favoriten" auf der Gruppenseite anzeigen',
    fr: 'Afficher la boîte « Favoris » sur la page de groupe',
    hu: '„Kedvencek” doboz megjelenítése a csoport oldalán',
    pl: 'Pokaż pole „Ulubione” na stronie grupy',
    ru: 'Показывать блок «Избранное» на странице группы',
    zh_CN: '在群组页面显示"收藏"框',
    zh_TW: '在群組頁面顯示「收藏」框',
    ja: 'グループページに「お気に入り」を表示',
  },
  'settings.warn_on_close_group': {
    en: 'Confirm before closing a group',
    de: 'Vor dem Schließen einer Gruppe bestätigen',
    fr: 'Confirmer avant de fermer un groupe',
    hu: 'Megerősítés csoport bezárása előtt',
    pl: 'Potwierdź przed zamknięciem grupy',
    ru: 'Подтверждать закрытие группы',
    zh_CN: '关闭组前确认',
    zh_TW: '關閉群組前確認',
    ja: 'グループを閉じる前に確認',
  },
  'settings.group_recent_count': {
    en: 'How many recent tabs to show',
    de: 'Anzahl der anzuzeigenden Tabs',
    fr: 'Nombre d’onglets récents à afficher',
    hu: 'Megjelenítendő lapok száma',
    pl: 'Ile ostatnich kart pokazać',
    ru: 'Сколько вкладок показывать',
    zh_CN: '显示多少个最近的标签页',
    zh_TW: '顯示多少個最近的分頁',
    ja: '表示する最近のタブの数',
  },
...
例：「*」、「ctrl+$」、「ctrl+alt+g」`,
  ...
  'settings.dedup_keep_newest': {
    en: "Reverse tab priority for 'Close duplicate tabs'",
    de: "Tab-Priorität für 'Doppelte Tabs schließen' umkehren",
    fr: "Inverser la priorité des onglets pour 'Fermer les onglets dupliqués'",
    hu: "Lapprioritás megfordítása a 'Másodpéldányok bezárása' funkcióhoz",
    pl: "Odwróć priorytet kart dla 'Zamknij zduplikowane karty'",
    ru: 'Обратный приоритет вкладок для «Закрыть дубликаты»',
    zh_CN: '反转“关闭重复的标签页”的标签页优先级',
...
- \`/page/\\d+ => /page/N\`: collapse paginated URLs to one key.`,
  ...
  'settings.fav_protect': {
    ...
    fr: 'Protéger les onglets favoris de la fermeture en masse et du déchargement auto',
    hu: 'Kedvenc lapok védelme a tömeges bezárástól és auto-kirakodástól',
    pl: 'Chroń ulubione karty przed masowym zamykaniem i autowyładowaniem',
    ru: 'Защищать избранные вкладки от массового закрытия и авто-выгрузки',
    zh_CN: '保护收藏的标签页，避免批量关闭和自动卸载',
    zh_TW: '保護收藏的分頁，避免批次關閉與自動卸載',
    ja: 'お気に入りタブを一括クローズと自動アンロードから保護',
  },
  'settings.group_top_activate': {
    en: "'Go to top of group' switches to the group tab (off = just scroll to it)",
    de: "'Zum Gruppenanfang' wechselt zum Gruppen-Tab (aus = nur hinscrollen)",
    fr: "'Aller en haut du groupe' bascule sur l'onglet de groupe (désactivé = simple défilement)",
    hu: "'Ugrás a csoport tetejére' a csoportlapra vált (ki = csak odagörget)",
    pl: "'Przejdź na górę grupy' przełącza na kartę grupy (wył. = tylko przewija)",
    ru: '«Перейти к началу группы» переключает на вкладку группы (выкл. = просто прокрутка)',
    zh_CN: '“转到组顶部”切换到组标签页（关闭时仅滚动到它）',
    zh_TW: '「跳到群組頂部」切換到群組分頁（關閉時僅捲動到它）',
    ja: '「グループの先頭へ」でグループタブに切り替え（オフ時はスクロールのみ）',
  },
...
- \`minIdleTime:{Milliseconds}\`: Applies the rule when the tab title changes after the tab has been idle for at least \`{Milliseconds}\`.`,
  ...
  'settings.tabs_reload_batch_delay': {
    en: 'Slow down bulk reloads per site',
    de: 'Massen-Neuladen pro Website drosseln',
    fr: 'Ralentir le rechargement en masse par site',
    hu: 'Tömeges újratöltés lassítása webhelyenként',
    pl: 'Spowolnij masowe przeładowania na stronę',
    ru: 'Замедлять массовую перезагрузку по сайтам',
    zh_CN: '按站点减缓批量重新加载',
    zh_TW: '按網站減緩批次重新載入',
    ja: 'サイトごとに一括再読み込みを遅くする',
  },
  'settings.tabs_reload_batch_delay_every': {
    en: 'Pause after every N reloads of the same site',
    de: 'Pause nach je N Neuladen derselben Website',
    fr: 'Pause après chaque N rechargements du même site',
    hu: 'Szünet ugyanazon webhely minden N újratöltése után',
    pl: 'Pauza po każdych N przeładowaniach tej samej strony',
    ru: 'Пауза после каждых N перезагрузок одного сайта',
    zh_CN: '同一站点每 N 次重新加载后暂停',
    zh_TW: '同一網站每 N 次重新載入後暫停',
    ja: '同じサイトをN回再読み込みするごとに一時停止',
  },
  'settings.tabs_reload_batch_delay_ms': {
    en: 'Pause duration (ms)',
    de: 'Pausendauer (ms)',
    fr: 'Durée de la pause (ms)',
    hu: 'Szünet időtartama (ms)',
    pl: 'Czas pauzy (ms)',
    ru: 'Длительность паузы (мс)',
    zh_CN: '暂停时长（毫秒）',
    zh_TW: '暫停時長（毫秒）',
    ja: '一時停止時間（ミリ秒）',
  },
  'settings.tabs_reload_batch_delay_min': {
    en: 'Only for sites with more than N tabs',
    de: 'Nur für Websites mit mehr als N Tabs',
    fr: 'Seulement pour les sites avec plus de N onglets',
    hu: 'Csak N-nél több lappal rendelkező webhelyekhez',
    pl: 'Tylko dla stron z więcej niż N kartami',
    ru: 'Только для сайтов с более чем N вкладками',
    zh_CN: '仅适用于超过 N 个标签页的站点',
    zh_TW: '僅適用於超過 N 個分頁的網站',
    ja: 'N個を超えるタブを持つサイトのみ',
  },
  ...
  'settings.move_new_tab_parent_limited': {
    en: '...but when opener is at the tree depth limit',
    de: '...aber wenn der öffnende Tab am Baumtiefenlimit ist',
    fr: "...mais quand l'onglet d'origine est à la limite de profondeur de l'arbre",
    hu: '...de ha a megnyitó lap a fa mélységi korlátján van',
    pl: '...ale gdy karta otwierająca jest na limicie głębokości drzewa',
    ru: '...но когда исходная вкладка на пределе глубины дерева',
    zh_CN: '...但当来源标签页处于树深度限制时',
    zh_TW: '...但當來源分頁處於樹狀深度限制時',
    ja: '...ただし開いたタブがツリーの深さ制限にあるとき',
  },
  ...
  'settings.move_new_tab_parent_after_last_sibling': {
    en: 'after last tab at same level',
    de: 'Nach letztem Tab auf gleicher Ebene',
    fr: 'après le dernier onglet au même niveau',
    hu: 'az azonos szintű utolsó lap után',
    pl: 'po ostatniej karcie na tym samym poziomie',
    ru: 'после последней вкладки на том же уровне',
    zh_CN: '同级最后一个标签页之后',
    zh_TW: '同層最後一個分頁之後',
    ja: '同じレベルの最後のタブの後',
  },
  ...
  'settings.move_new_tab_after_last_sibling': {
    en: 'after last tab at same level',
    de: 'Nach letztem Tab auf gleicher Ebene',
    fr: 'après le dernier onglet au même niveau',
    hu: 'az azonos szintű utolsó lap után',
