...
export const commonTranslations: Translations = {
  ...
  'menu.tab.favourite': {
    en: 'Add to group favourites',
    de: 'Zu Gruppenfavoriten hinzufügen',
    fr: 'Ajouter aux favoris du groupe',
    hu: 'Hozzáadás a csoport kedvenceihez',
    pl: 'Dodaj do ulubionych grupy',
    ru: 'Добавить в избранное группы',
    zh_CN: '添加到组收藏',
    zh_TW: '加入群組收藏',
    ja: 'グループのお気に入りに追加',
  },
  'menu.tab.unfavourite': {
    en: 'Remove from group favourites',
    de: 'Aus Gruppenfavoriten entfernen',
    fr: 'Retirer des favoris du groupe',
    hu: 'Eltávolítás a csoport kedvenceiből',
    pl: 'Usuń z ulubionych grupy',
    ru: 'Убрать из избранного группы',
    zh_CN: '从组收藏中移除',
    zh_TW: '從群組收藏中移除',
    ja: 'グループのお気に入りから削除',
  },
  ...
  'menu.tab.dedupe_branch_by_title': {
    ...
    fr: 'Fermer les onglets dupliqués du groupe (par titre)',
    hu: 'Másodpéldány lapok bezárása a csoportban (cím szerint)',
    pl: 'Zamknij zduplikowane karty w grupie (wg tytułu)',
    ru: 'Закрыть дубликаты в группе (по заголовку)',
    zh_CN: '关闭组内重复的标签页（按标题）',
    zh_TW: '關閉群組內重複的分頁（依標題）',
    ja: 'グループ内の重複タブを閉じる（タイトル別）',
  },
  'menu.tab.dedupe_subgroup_by_title': {
    en: 'Close duplicate tabs in subgroups (by title)',
    de: 'Doppelte Tabs in Untergruppen schließen (nach Titel)',
    fr: 'Fermer les onglets dupliqués dans les sous-groupes (par titre)',
    hu: 'Másodpéldány lapok bezárása az alcsoportokban (cím szerint)',
    pl: 'Zamknij zduplikowane karty w podgrupach (wg tytułu)',
    ru: 'Закрыть дубликаты в подгруппах (по заголовку)',
    zh_CN: '关闭子组内重复的标签页（按标题）',
    zh_TW: '關閉子群組內重複的分頁（依標題）',
    ja: 'サブグループ内の重複タブを閉じる（タイトル別）',
  },
  'menu.tab.set_shared_parent': {
    en: 'Mark as shared parent',
    de: 'Als gemeinsames Elternelement markieren',
    fr: 'Marquer comme parent partagé',
    hu: 'Megjelölés közös szülőként',
    pl: 'Oznacz jako wspólny rodzic',
    ru: 'Отметить как общий родитель',
    zh_CN: '标记为共享父级',
    zh_TW: '標記為共享父級',
    ja: '共有親として設定',
  },
  'menu.tab.unset_shared_parent': {
    en: 'Unmark shared parent',
    de: 'Markierung als gemeinsames Elternelement entfernen',
    fr: 'Retirer le marquage de parent partagé',
    hu: 'Közös szülő megjelölés eltávolítása',
    pl: 'Usuń oznaczenie wspólnego rodzica',
    ru: 'Снять отметку общего родителя',
    zh_CN: '取消标记共享父级',
    zh_TW: '取消標記共享父級',
    ja: '共有親の設定を解除',
  },
